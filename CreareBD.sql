--------------------------------------------------------
--  File created - sâmbãtã-martie-20-2021   
--------------------------------------------------------
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "SYSTEM"."CATALOG_UNIVERSITATE_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 361 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence DISCIPLINE_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."DISCIPLINE_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 121 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence PREZENTE_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."PREZENTE_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 341 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence PROFESORI_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."PROFESORI_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 141 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence STUDENTI_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."STUDENTI_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 141 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table DISCIPLINE_PROFESORI
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."DISCIPLINE_PROFESORI" 
   (	"ID_P" NUMBER, 
	"ID_D" NUMBER
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table PAROLA_SECRETARIAT
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."PAROLA_SECRETARIAT" 
   (	"PAROLA" VARCHAR2(40 BYTE)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table PROFESORI
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."PROFESORI" 
   (	"ID" NUMBER, 
	"CNP" CHAR(13 BYTE), 
...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for View DISCIPLINE_PROFESORI_VIEW
--------------------------------------------------------

  CREATE OR REPLACE FORCE NONEDITIONABLE VIEW "SYSTEM"."DISCIPLINE_PROFESORI_VIEW" ("ID_PROFESOR", "NUME_PROFESOR", "PRENUME_PROFESOR", "ID_DISCIPLINA", "NUME_DISCIPLINA") AS 
  SELECT P.ID AS ID_PROFESOR,P.NUME NUME_PROFESOR,P.PRENUME PRENUME_PROFESOR,D.ID ID_DISCIPLINA,D.NUME_DISCIPLINA FROM DISCIPLINE_PROFESORI DP
        LEFT JOIN PROFESORI P ON P.ID = DP.ID_P
        JOIN DISCIPLINE D ON D.ID = DP.ID_D
;
--------------------------------------------------------
--  DDL for View DISCIPLINE_STUDENTI_VIEW
--------------------------------------------------------

  CREATE OR REPLACE FORCE NONEDITIONABLE VIEW "SYSTEM"."DISCIPLINE_STUDENTI_VIEW" ("NR_MATRICOL", "CNP", "NUME", "PRENUME", "ID_D", "NUME_DISCIPLINA", "PREZENTE_MINIME", "PREZENTE_STUDENT", "MEDIA", "NUME_PROFESOR", "PRENUME_PROFESOR", "EMAIL_PROFESOR", "NRTEL_PROFESOR", "ID_PROFESOR", "EMAIL_STUDENT", "NRTEL_STUDENT") AS 
...
END AS PREZENTE_MINIME, NVL(NPV.PREZENTE_STUDENT,0), MSV.MEDIA, P.NUME, P.PRENUME, P.EMAIL, P.NRTEL, P.ID, S.EMAIL, S.NRTEL
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE NONEDITIONABLE VIEW "SYSTEM"."NOTE_VIEW" ("ID_NOTA", "NR_MATRICOL", "CNP", "DATA", "NUME_DISCIPLINA", "PUNCTAJ", "TIP", "ID_D", "ID_PROF", "NUME_COMPLET_PROF") AS 
  SELECT CU.ID_NOTA,CU.NR_MATRICOL,S.CNP,CU.DATA, D.NUME_DISCIPLINA, CU.PUNCTAJ,CU.TIP, CU.ID_D, CU.ID_PROF, P.NUME||' '||P.PRENUME AS NUME_COMPLET_PROF
FROM CATALOG_UNIVERSITATE CU, DISCIPLINE D, STUDENTI S, PROFESORI P
WHERE CU.ID_D = D.ID AND CU.NR_MATRICOL = S.NR_MATRICOL AND CU.ID_PROF = P.ID
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE NONEDITIONABLE VIEW "SYSTEM"."PREZENTE_VIEW" ("ID_PREZ", "DATA", "NR_MATRICOL", "CNP", "ID_D", "NUME_DISCIPLINA", "ID_PROF") AS 
  SELECT P.ID_PREZ, P.DATA, P.NR_MATRICOL, S.CNP, P.ID_D, D.NUME_DISCIPLINA, P.ID_PROF
...
REM INSERTING into SYSTEM.CATALOG_UNIVERSITATE
SET DEFINE OFF;
Insert into SYSTEM.CATALOG_UNIVERSITATE (ID_NOTA,DATA,NR_MATRICOL,ID_D,PUNCTAJ,TIP,ID_PROF) values ('343',to_date('05-12-2020','DD-MM-RRRR'),'124','81','8,5','T','101');
Insert into SYSTEM.CATALOG_UNIVERSITATE (ID_NOTA,DATA,NR_MATRICOL,ID_D,PUNCTAJ,TIP,ID_PROF) values ('341',to_date('16-02-2021','DD-MM-RRRR'),'124','81','10','E','101');
Insert into SYSTEM.CATALOG_UNIVERSITATE (ID_NOTA,DATA,NR_MATRICOL,ID_D,PUNCTAJ,TIP,ID_PROF) values ('342',to_date('04-11-2020','DD-MM-RRRR'),'124','81','9','T','101');
REM INSERTING into SYSTEM.DISCIPLINE
SET DEFINE OFF;
Insert into SYSTEM.DISCIPLINE (ID,NUME_DISCIPLINA,PREZENTE_MINIME_NANG,PREZENTE_MINIME_ANG,NR_TESTE,PROCENT_TESTE,PROCENT_EXAMEN,BONUS) values ('103','SO2','8','6','0','0','100','0');
Insert into SYSTEM.DISCIPLINE (ID,NUME_DISCIPLINA,PREZENTE_MINIME_NANG,PREZENTE_MINIME_ANG,NR_TESTE,PROCENT_TESTE,PROCENT_EXAMEN,BONUS) values ('81','ASD1','10','7','2','70','30','0');
REM INSERTING into SYSTEM.DISCIPLINE_PROFESORI
SET DEFINE OFF;
Insert into SYSTEM.DISCIPLINE_PROFESORI (ID_P,ID_D) values ('101','81');
Insert into SYSTEM.DISCIPLINE_PROFESORI (ID_P,ID_D) values ('121','103');
Insert into SYSTEM.DISCIPLINE_PROFESORI (ID_P,ID_D) values ('122','103');
REM INSERTING into SYSTEM.DISCIPLINE_STUDENTI
SET DEFINE OFF;
Insert into SYSTEM.DISCIPLINE_STUDENTI (NR_MATRICOL,ID_D,ID_P) values ('123','81','101');
Insert into SYSTEM.DISCIPLINE_STUDENTI (NR_MATRICOL,ID_D,ID_P) values ('123','103','121');
Insert into SYSTEM.DISCIPLINE_STUDENTI (NR_MATRICOL,ID_D,ID_P) values ('124','81','101');
Insert into SYSTEM.DISCIPLINE_STUDENTI (NR_MATRICOL,ID_D,ID_P) values ('124','103','122');
Insert into SYSTEM.DISCIPLINE_STUDENTI (NR_MATRICOL,ID_D,ID_P) values ('125','103','122');
REM INSERTING into SYSTEM.PAROLA_SECRETARIAT
SET DEFINE OFF;
Insert into SYSTEM.PAROLA_SECRETARIAT (PAROLA) values ('root');
REM INSERTING into SYSTEM.PREZENTE
SET DEFINE OFF;
Insert into SYSTEM.PREZENTE (ID_PREZ,DATA,NR_MATRICOL,ID_D,ID_PROF) values ('323',to_date('14-10-2020','DD-MM-RRRR'),'124','81','101');
Insert into SYSTEM.PREZENTE (ID_PREZ,DATA,NR_MATRICOL,ID_D,ID_PROF) values ('321',to_date('01-10-2020','DD-MM-RRRR'),'124','81','101');
Insert into SYSTEM.PREZENTE (ID_PREZ,DATA,NR_MATRICOL,ID_D,ID_PROF) values ('322',to_date('07-10-2020','DD-MM-RRRR'),'124','81','101');
REM INSERTING into SYSTEM.PROFESORI
SET DEFINE OFF;
Insert into SYSTEM.PROFESORI (ID,CNP,NUME,PRENUME,NRTEL,EMAIL,ADRESA,PAROLA) values ('101','2890204126277','IONESCU','ALINA','0766543823','ionescu.alina89@e-uvt.ro','Timi?,Timi?oara,Bd. V. Parvan 25','FNRUPOC1RZ');
Insert into SYSTEM.PROFESORI (ID,CNP,NUME,PRENUME,NRTEL,EMAIL,ADRESA,PAROLA) values ('122','2900720378007','NEME?','LARISA','0748763543','nemes.larisa90@e-uvt.ro','Timi?,Timi?oara,Bd Iuliu Maniu 19','OHIHVFZX8P');
Insert into SYSTEM.PROFESORI (ID,CNP,NUME,PRENUME,NRTEL,EMAIL,ADRESA,PAROLA) values ('121','1980412085374','MURE?AN','DARIUS ION','0776432123','muresan.darius88@e-uvt.ro','Timi?,Timi?oara,Str. Cosmonau?ilor 8','CSSZ4MMWIW');
REM INSERTING into SYSTEM.STUDENTI
SET DEFINE OFF;
Insert into SYSTEM.STUDENTI (NR_MATRICOL,CNP,NUME,PRENUME,NRTEL,EMAIL,ADRESA,SOLD,ANGAJAT,PAROLA) values ('124','5000715309434','PAL','ADRIAN','0756783564','adrian.pal00@e-uvt.ro','Str. G. Cosbuc 25','120','1','54321');
Insert into SYSTEM.STUDENTI (NR_MATRICOL,CNP,NUME,PRENUME,NRTEL,EMAIL,ADRESA,SOLD,ANGAJAT,PAROLA) values ('123','5001025245037','RO?CA','PAUL-TEODOR','0746283123','paul.rosca00@e-uvt.ro','Bd. V. Parvan 15','0','0','12345');
Insert into SYSTEM.STUDENTI (NR_MATRICOL,CNP,NUME,PRENUME,NRTEL,EMAIL,ADRESA,SOLD,ANGAJAT,PAROLA) values ('125','1901009292679','POPESCU','ADRIAN','0759321743','popescu.adrian99@e-uvt.ro','Bd. Vasile Lucaciu 25','0','1','Q14WL3AGGB');
REM INSERTING into SYSTEM.DISCIPLINE_PROFESORI_VIEW
SET DEFINE OFF;
Insert into SYSTEM.DISCIPLINE_PROFESORI_VIEW (ID_PROFESOR,NUME_PROFESOR,PRENUME_PROFESOR,ID_DISCIPLINA,NUME_DISCIPLINA) values ('101','IONESCU','ALINA','81','ASD1');
Insert into SYSTEM.DISCIPLINE_PROFESORI_VIEW (ID_PROFESOR,NUME_PROFESOR,PRENUME_PROFESOR,ID_DISCIPLINA,NUME_DISCIPLINA) values ('122','NEME?','LARISA','103','SO2');
Insert into SYSTEM.DISCIPLINE_PROFESORI_VIEW (ID_PROFESOR,NUME_PROFESOR,PRENUME_PROFESOR,ID_DISCIPLINA,NUME_DISCIPLINA) values ('121','MURE?AN','DARIUS ION','103','SO2');
REM INSERTING into SYSTEM.DISCIPLINE_STUDENTI_VIEW
SET DEFINE OFF;
Insert into SYSTEM.DISCIPLINE_STUDENTI_VIEW (NR_MATRICOL,CNP,NUME,PRENUME,ID_D,NUME_DISCIPLINA,PREZENTE_MINIME,PREZENTE_STUDENT,MEDIA,NUME_PROFESOR,PRENUME_PROFESOR,EMAIL_PROFESOR,NRTEL_PROFESOR,ID_PROFESOR,EMAIL_STUDENT,NRTEL_STUDENT) values ('125','1901009292679','POPESCU','ADRIAN','103','SO2','6','0','0','NEME?','LARISA','nemes.larisa90@e-uvt.ro','0748763543','122','popescu.adrian99@e-uvt.ro','0759321743');
Insert into SYSTEM.DISCIPLINE_STUDENTI_VIEW (NR_MATRICOL,CNP,NUME,PRENUME,ID_D,NUME_DISCIPLINA,PREZENTE_MINIME,PREZENTE_STUDENT,MEDIA,NUME_PROFESOR,PRENUME_PROFESOR,EMAIL_PROFESOR,NRTEL_PROFESOR,ID_PROFESOR,EMAIL_STUDENT,NRTEL_STUDENT) values ('123','5001025245037','RO?CA','PAUL-TEODOR','81','ASD1','10','0','0','IONESCU','ALINA','ionescu.alina89@e-uvt.ro','0766543823','101','paul.rosca00@e-uvt.ro','0746283123');
Insert into SYSTEM.DISCIPLINE_STUDENTI_VIEW (NR_MATRICOL,CNP,NUME,PRENUME,ID_D,NUME_DISCIPLINA,PREZENTE_MINIME,PREZENTE_STUDENT,MEDIA,NUME_PROFESOR,PRENUME_PROFESOR,EMAIL_PROFESOR,NRTEL_PROFESOR,ID_PROFESOR,EMAIL_STUDENT,NRTEL_STUDENT) values ('124','5000715309434','PAL','ADRIAN','103','SO2','6','0','0','NEME?','LARISA','nemes.larisa90@e-uvt.ro','0748763543','122','adrian.pal00@e-uvt.ro','0756783564');
Insert into SYSTEM.DISCIPLINE_STUDENTI_VIEW (NR_MATRICOL,CNP,NUME,PRENUME,ID_D,NUME_DISCIPLINA,PREZENTE_MINIME,PREZENTE_STUDENT,MEDIA,NUME_PROFESOR,PRENUME_PROFESOR,EMAIL_PROFESOR,NRTEL_PROFESOR,ID_PROFESOR,EMAIL_STUDENT,NRTEL_STUDENT) values ('124','5000715309434','PAL','ADRIAN','81','ASD1','7','3','9','IONESCU','ALINA','ionescu.alina89@e-uvt.ro','0766543823','101','adrian.pal00@e-uvt.ro','0756783564');
Insert into SYSTEM.DISCIPLINE_STUDENTI_VIEW (NR_MATRICOL,CNP,NUME,PRENUME,ID_D,NUME_DISCIPLINA,PREZENTE_MINIME,PREZENTE_STUDENT,MEDIA,NUME_PROFESOR,PRENUME_PROFESOR,EMAIL_PROFESOR,NRTEL_PROFESOR,ID_PROFESOR,EMAIL_STUDENT,NRTEL_STUDENT) values ('123','5001025245037','RO?CA','PAUL-TEODOR','103','SO2','8','0','0','MURE?AN','DARIUS ION','muresan.darius88@e-uvt.ro','0776432123','121','paul.rosca00@e-uvt.ro','0746283123');
REM INSERTING into SYSTEM.MEDII_STUDENT_VIEW
SET DEFINE OFF;
Insert into SYSTEM.MEDII_STUDENT_VIEW (NR_MATRICOL,ID_D,MEDIA) values ('125','103','0');
Insert into SYSTEM.MEDII_STUDENT_VIEW (NR_MATRICOL,ID_D,MEDIA) values ('123','81','0');
Insert into SYSTEM.MEDII_STUDENT_VIEW (NR_MATRICOL,ID_D,MEDIA) values ('124','103','0');
Insert into SYSTEM.MEDII_STUDENT_VIEW (NR_MATRICOL,ID_D,MEDIA) values ('124','81','9');
Insert into SYSTEM.MEDII_STUDENT_VIEW (NR_MATRICOL,ID_D,MEDIA) values ('123','103','0');
REM INSERTING into SYSTEM.NOTE_CENTRALIZATE_VIEW
SET DEFINE OFF;
Insert into SYSTEM.NOTE_CENTRALIZATE_VIEW (NR_MATRICOL,ID_D,MEDIE_TESTE,NOTA_EXAMEN,PUNCTE_BONUS) values ('125','103','0','0','0');
Insert into SYSTEM.NOTE_CENTRALIZATE_VIEW (NR_MATRICOL,ID_D,MEDIE_TESTE,NOTA_EXAMEN,PUNCTE_BONUS) values ('123','81','0','0','0');
Insert into SYSTEM.NOTE_CENTRALIZATE_VIEW (NR_MATRICOL,ID_D,MEDIE_TESTE,NOTA_EXAMEN,PUNCTE_BONUS) values ('124','103','0','0','0');
Insert into SYSTEM.NOTE_CENTRALIZATE_VIEW (NR_MATRICOL,ID_D,MEDIE_TESTE,NOTA_EXAMEN,PUNCTE_BONUS) values ('124','81','9','10','0');
Insert into SYSTEM.NOTE_CENTRALIZATE_VIEW (NR_MATRICOL,ID_D,MEDIE_TESTE,NOTA_EXAMEN,PUNCTE_BONUS) values ('123','103','0','0','0');
REM INSERTING into SYSTEM.NOTE_VIEW
SET DEFINE OFF;
Insert into SYSTEM.NOTE_VIEW (ID_NOTA,NR_MATRICOL,CNP,DATA,NUME_DISCIPLINA,PUNCTAJ,TIP,ID_D,ID_PROF,NUME_COMPLET_PROF) values ('341','124','5000715309434',to_date('16-02-2021','DD-MM-RRRR'),'ASD1','10','E','81','101','IONESCU ALINA');
Insert into SYSTEM.NOTE_VIEW (ID_NOTA,NR_MATRICOL,CNP,DATA,NUME_DISCIPLINA,PUNCTAJ,TIP,ID_D,ID_PROF,NUME_COMPLET_PROF) values ('343','124','5000715309434',to_date('05-12-2020','DD-MM-RRRR'),'ASD1','8,5','T','81','101','IONESCU ALINA');
Insert into SYSTEM.NOTE_VIEW (ID_NOTA,NR_MATRICOL,CNP,DATA,NUME_DISCIPLINA,PUNCTAJ,TIP,ID_D,ID_PROF,NUME_COMPLET_PROF) values ('342','124','5000715309434',to_date('04-11-2020','DD-MM-RRRR'),'ASD1','9','T','81','101','IONESCU ALINA');
REM INSERTING into SYSTEM.NUMAR_PREZENTE_VIEW
SET DEFINE OFF;
Insert into SYSTEM.NUMAR_PREZENTE_VIEW (NR_MATRICOL,ID_D,PREZENTE_STUDENT) values ('124','81','3');
REM INSERTING into SYSTEM.NUMAR_TESTE_STUDENT_DISCIPLINA_VIEW
SET DEFINE OFF;
Insert into SYSTEM.NUMAR_TESTE_STUDENT_DISCIPLINA_VIEW (NR_MATRICOL,ID_D,NR_TESTE) values ('124','81','2');
Insert into SYSTEM.NUMAR_TESTE_STUDENT_DISCIPLINA_VIEW (NR_MATRICOL,ID_D,NR_TESTE) values ('125','103','0');
Insert into SYSTEM.NUMAR_TESTE_STUDENT_DISCIPLINA_VIEW (NR_MATRICOL,ID_D,NR_TESTE) values ('123','81','0');
Insert into SYSTEM.NUMAR_TESTE_STUDENT_DISCIPLINA_VIEW (NR_MATRICOL,ID_D,NR_TESTE) values ('124','103','0');
Insert into SYSTEM.NUMAR_TESTE_STUDENT_DISCIPLINA_VIEW (NR_MATRICOL,ID_D,NR_TESTE) values ('123','103','0');
REM INSERTING into SYSTEM.PREZENTE_VIEW
SET DEFINE OFF;
Insert into SYSTEM.PREZENTE_VIEW (ID_PREZ,DATA,NR_MATRICOL,CNP,ID_D,NUME_DISCIPLINA,ID_PROF) values ('323',to_date('14-10-2020','DD-MM-RRRR'),'124','5000715309434','81','ASD1','101');
Insert into SYSTEM.PREZENTE_VIEW (ID_PREZ,DATA,NR_MATRICOL,CNP,ID_D,NUME_DISCIPLINA,ID_PROF) values ('322',to_date('07-10-2020','DD-MM-RRRR'),'124','5000715309434','81','ASD1','101');
Insert into SYSTEM.PREZENTE_VIEW (ID_PREZ,DATA,NR_MATRICOL,CNP,ID_D,NUME_DISCIPLINA,ID_PROF) values ('321',to_date('01-10-2020','DD-MM-RRRR'),'124','5000715309434','81','ASD1','101');
REM INSERTING into SYSTEM.NUMAR_TESTE_STUDENT_MVIEW
SET DEFINE OFF;
Insert into SYSTEM.NUMAR_TESTE_STUDENT_MVIEW (NR_MATRICOL,ID_D,NUMAR_TESTE_DISCIPLINA) values ('124','81','2');
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index CATALOG_UNIVERSITATE_UK1
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."CATALOG_UNIVERSITATE_UK1" ON "SYSTEM"."CATALOG_UNIVERSITATE" ("NR_MATRICOL", "ID_D", "DATA", "TIP", "ID_PROF") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index DISCIPLINE_PROFESORI_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."DISCIPLINE_PROFESORI_PK" ON "SYSTEM"."DISCIPLINE_PROFESORI" ("ID_P", "ID_D") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index EMAIL_PROF_UK
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."EMAIL_PROF_UK" ON "SYSTEM"."PROFESORI" ("EMAIL") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index EMAIL_STUDENT_UK
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."EMAIL_STUDENT_UK" ON "SYSTEM"."STUDENTI" ("EMAIL") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index INREGISTRARI_PK1
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."INREGISTRARI_PK1" ON "SYSTEM"."DISCIPLINE_STUDENTI" ("NR_MATRICOL", "ID_D", "ID_P") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index I_SNAP$_NUMAR_TESTE_STUDENT_MVIEW
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index PAROLA_SECRETARIAT_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."PAROLA_SECRETARIAT_PK" ON "SYSTEM"."PAROLA_SECRETARIAT" ("PAROLA") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index PROFESORI_CNP_UK
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."PROFESORI_CNP_UK" ON "SYSTEM"."PROFESORI" ("CNP") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index PROFESORI_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."PROFESORI_PK" ON "SYSTEM"."PROFESORI" ("ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
--  DDL for Trigger PAROLA_PROF_TRG
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE TRIGGER "SYSTEM"."PAROLA_PROF_TRG" 
...
BEGIN
    IF :NEW.PAROLA IS NULL THEN
        IF INSERTING THEN
            :NEW.PAROLA := DBMS_RANDOM.string('x',10);
        ELSIF UPDATING THEN
            RAISE_APPLICATION_ERROR(-20666, 'PAROLA NULA');
        END IF;
    END IF;
END;
/
ALTER TRIGGER "SYSTEM"."PAROLA_PROF_TRG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger PAROLA_STUD_TRG
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE TRIGGER "SYSTEM"."PAROLA_STUD_TRG" 
...
END;
/
ALTER TRIGGER "SYSTEM"."PAROLA_STUD_TRG" ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
--  DDL for Trigger PROCENTE_TRG
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE TRIGGER "SYSTEM"."PROCENTE_TRG" 
BEFORE INSERT OR UPDATE OF NR_TESTE,PROCENT_EXAMEN ON DISCIPLINE 
REFERENCING OLD AS OLD NEW AS NEW 
FOR EACH ROW
BEGIN
  IF :NEW.NR_TESTE = 0 AND :NEW.PROCENT_EXAMEN != 100 THEN
        :NEW.PROCENT_EXAMEN := 100;
        :NEW.PROCENT_TESTE := 0;
  END IF;
END;
/
ALTER TRIGGER "SYSTEM"."PROCENTE_TRG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger PROFESORI_CNP_TRG
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE TRIGGER "SYSTEM"."PROFESORI_CNP_TRG" 
BEFORE INSERT OR UPDATE OF CNP ON PROFESORI 
REFERENCING OLD AS OLD NEW AS NEW 
FOR EACH ROW
DECLARE
    s NUMBER(4,0):=0;
...
END;
/
ALTER TRIGGER "SYSTEM"."PROFESORI_CNP_TRG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger PROFESORI_TRG
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE TRIGGER "SYSTEM"."PROFESORI_TRG" 
...
BEGIN
  ...
  BEGIN
    IF INSERTING AND :NEW.ID IS NULL THEN
      SELECT PROFESORI_SEQ.NEXTVAL INTO :NEW.ID FROM SYS.DUAL;
    END IF;
  END COLUMN_SEQUENCES;
END;
/
ALTER TRIGGER "SYSTEM"."PROFESORI_TRG" ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
--  DDL for Trigger TRIM_PROF_TRG
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE TRIGGER "SYSTEM"."TRIM_PROF_TRG" 
BEFORE INSERT OR UPDATE ON PROFESORI 
REFERENCING OLD AS OLD NEW AS NEW 
FOR EACH ROW
BEGIN
    ...
    :NEW.PAROLA := TRIM(:NEW.PAROLA);
END;
/
ALTER TRIGGER "SYSTEM"."TRIM_PROF_TRG" ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."CATALOG_UNIVERSITATE" MODIFY ("ID_PROF" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."CATALOG_UNIVERSITATE" ADD CONSTRAINT "CATALOG_UNIVERSITATE_UK" UNIQUE ("NR_MATRICOL", "ID_D", "DATA", "TIP", "ID_PROF")
  USING INDEX (CREATE UNIQUE INDEX "SYSTEM"."CATALOG_UNIVERSITATE_UK1" ON "SYSTEM"."CATALOG_UNIVERSITATE" ("NR_MATRICOL", "ID_D", "DATA", "TIP", "ID_PROF") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM"  ENABLE;
--------------------------------------------------------
--  Constraints for Table DISCIPLINE_PROFESORI
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."DISCIPLINE_PROFESORI" MODIFY ("ID_P" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."DISCIPLINE_PROFESORI" MODIFY ("ID_D" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."DISCIPLINE_PROFESORI" ADD CONSTRAINT "DISCIPLINE_PROFESORI_PK" PRIMARY KEY ("ID_P", "ID_D")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."DISCIPLINE_STUDENTI" MODIFY ("ID_P" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."DISCIPLINE_STUDENTI" ADD CONSTRAINT "INREGISTRARI_PK" PRIMARY KEY ("NR_MATRICOL", "ID_D", "ID_P")
  USING INDEX (CREATE UNIQUE INDEX "SYSTEM"."INREGISTRARI_PK1" ON "SYSTEM"."DISCIPLINE_STUDENTI" ("NR_MATRICOL", "ID_D", "ID_P") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" )  ENABLE;
--------------------------------------------------------
--  Constraints for Table PAROLA_SECRETARIAT
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."PAROLA_SECRETARIAT" MODIFY ("PAROLA" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PAROLA_SECRETARIAT" ADD CONSTRAINT "PAROLA_SECRETARIAT_PK" PRIMARY KEY ("PAROLA")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."PREZENTE" MODIFY ("ID_PROF" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table PROFESORI
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."PROFESORI" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PROFESORI" ADD CONSTRAINT "PROFESORI_PK" PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."PROFESORI" MODIFY ("NUME" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PROFESORI" MODIFY ("PRENUME" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PROFESORI" MODIFY ("EMAIL" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PROFESORI" MODIFY ("NRTEL" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PROFESORI" ADD CONSTRAINT "EMAIL_PROF_UK" UNIQUE ("EMAIL")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."PROFESORI" ADD CONSTRAINT "NUME_PROF_CK" CHECK (REGEXP_LIKE (NUME , '^([a-z?îâ??A-Z?ÎÂ??]{3,}-{0,1})+$')) ENABLE;
  ALTER TABLE "SYSTEM"."PROFESORI" ADD CONSTRAINT "PRENUME_PROF_CK" CHECK (REGEXP_LIKE (PRENUME ,'^([a-z?îâ??A-Z?ÎÂ??]{3,}[-[:blank:]]{0,1})+$')) ENABLE;
  ALTER TABLE "SYSTEM"."PROFESORI" ADD CONSTRAINT "EMAIL_PROF_CK" CHECK (REGEXP_LIKE (EMAIL, '^([a-zA-Z0-9]+(-|\.|\_)*[a-zA-Z0-9]+)+@([a-zA-Z0-9]+(-|\.|\_)*[a-zA-Z0-9]+)+\.[a-z]{2,4}$')) ENABLE;
  ALTER TABLE "SYSTEM"."PROFESORI" ADD CONSTRAINT "NRTEL_PROF_CK" CHECK (REGEXP_LIKE (NRTEL,'^07[2-7][0-9]{7}$')) ENABLE;
  ALTER TABLE "SYSTEM"."PROFESORI" MODIFY ("CNP" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PROFESORI" ADD CONSTRAINT "PROFESORI_CNP_UK" UNIQUE ("CNP")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."PROFESORI" MODIFY ("PAROLA" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."STUDENTI" ADD CONSTRAINT "NUME_CK" CHECK (REGEXP_LIKE (NUME , '^([a-z?îâ??A-Z?ÎÂ??]{3,}-{0,1})+$')) ENABLE;
  ALTER TABLE "SYSTEM"."STUDENTI" ADD CONSTRAINT "PRENUME_CK" CHECK (REGEXP_LIKE (PRENUME ,'^([a-z?îâ??A-Z?ÎÂ??]{3,}[-[:blank:]]{0,1})+$')) ENABLE;
  ...
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."STUDENTI" ADD CONSTRAINT "EMAIL_STUDENT_UK" UNIQUE ("EMAIL")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."CATALOG_UNIVERSITATE" ADD CONSTRAINT "CATALOG_UNIVERSITATE_DISC_FK" FOREIGN KEY ("NR_MATRICOL", "ID_D", "ID_PROF")
	  REFERENCES "SYSTEM"."DISCIPLINE_STUDENTI" ("NR_MATRICOL", "ID_D", "ID_P") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table DISCIPLINE_PROFESORI
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."DISCIPLINE_PROFESORI" ADD CONSTRAINT "DISCIPLINE_PROFESORI_PROF_FK" FOREIGN KEY ("ID_P")
	  REFERENCES "SYSTEM"."PROFESORI" ("ID") ON DELETE CASCADE ENABLE;
  ALTER TABLE "SYSTEM"."DISCIPLINE_PROFESORI" ADD CONSTRAINT "DISCIPLINE_PROFESORI_DISC_FK" FOREIGN KEY ("ID_D")
	  REFERENCES "SYSTEM"."DISCIPLINE" ("ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table DISCIPLINE_STUDENTI
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."DISCIPLINE_STUDENTI" ADD CONSTRAINT "DISCIPLINE_STUDENTI_PD_FK" FOREIGN KEY ("ID_P", "ID_D")
	  REFERENCES "SYSTEM"."DISCIPLINE_PROFESORI" ("ID_P", "ID_D") ON DELETE CASCADE ENABLE;
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."PREZENTE" ADD CONSTRAINT "PREZENTE_DISC_FK" FOREIGN KEY ("NR_MATRICOL", "ID_D", "ID_PROF")
	  REFERENCES "SYSTEM"."DISCIPLINE_STUDENTI" ("NR_MATRICOL", "ID_D", "ID_P") ON DELETE CASCADE ENABLE;
